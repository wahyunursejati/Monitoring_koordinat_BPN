<?php
    ...
    $districts = ['Mengecek Koordinat','Kepemilikan sertifikat'];
    $populationCounts = [];
    $query = $koneksi->prepare("SELECT * FROM aduan WHERE jenis = ?");
                        ...
                        <div class="box">
                            <div class="box-header">
                                <ul class="btn">
                                    ...
                                    <li><a href="koordinat.php"><i class="fas fa-map-marker-alt"></i>Pergeseran</a></li>
                                    <li class="active"><a href="#"><i class="fa-solid fa-bell"></i>Aduan</a></li>
                                </ul>
                            </div>
                            <div class="statistik">
                                <div>
