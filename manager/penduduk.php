<?php
    ...
    include 'koneksi.php';
    $districts = ['Sleman', 'Bantul', 'Kota Yogyakarta', 'Gunung Kidul','Kulon Progo'];
    $populationCounts = [];
    $query = $koneksi->prepare("SELECT * FROM data_pemiliksertif 
    JOIN sertifikat ON data_pemiliksertif.NIK = sertifikat.NIK 
    JOIN kabupaten ON sertifikat.Id_Kab = kabupaten.Id_Kab WHERE Nama_Kab = ?");
                    ...
                    <div class="col-xs-12">
                        <div class="box">
                            <div class="box-header">
                                <ul class="btn">
                                    <li class="active"><a href="#"><i class="fas fa-solid fa-scroll"></i>Sertifikat</a></li>
                                    <li><a href="statistik/koordinat.php"><i class="fas fa-map-marker-alt"></i>Pergeseran</a></li>
                                    <li><a href="statistik/aduan.php"><i class="fa-solid fa-bell"></i>Aduan</a></li>
                                </ul>
                            </div>
                            <div class="statistik">
                                <div>
                            ...
                            var penduduk = new Chart(pendudukChart, {
                                ...
                                data: {
                                    ...
                                    datasets: [{
                                        label: 'Jumlah Pemilik Sertifikat',
                                        data: populationData,
