...
WHERE login.username = '$username' AND kabupaten.Nama_Kab = 'Kota Yogyakarta'";
...
<html>
    <head>
        ...
        <title>Bantul</title>
        <link rel="stylesheet" type="text/css" href="css/kota.css">
    ...
    if(mysqli_num_rows($sertifikat_result) == 0) {
        ...
        <h2>Anda tidak memiliki sertifikat di Kota Yogyakarta</h2>
        </div>";
    }
    ?>
        </div>
