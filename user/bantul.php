...
$sertifikat_query = "SELECT sertifikat.Id_NoSertif, 
                    ...
                    WHERE login.username = '$username' AND kabupaten.Nama_Kab = 'Bantul'";
...
<html>
    <head>
        ...
        <title>Bantul</title>
        <link rel="stylesheet" type="text/css" href="css/bantul.css">
    ...
    if(mysqli_num_rows($sertifikat_result) == 0) {
        ...
        <h2>Anda tidak memiliki sertifikat di Bantul</h2>
        </div>";
    }
    ?>
        </div>
