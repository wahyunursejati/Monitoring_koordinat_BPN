...
$sertifikat_query = "SELECT sertifikat.Id_NoSertif, 
                    ...
                    WHERE login.username = '$username' AND kabupaten.Nama_Kab = 'Gunung Kidul'";
...
<html>
    <head>
        ...
        <title>GK</title>
        <link rel="stylesheet" type="text/css" href="css/gk.css">
    ...
    if(mysqli_num_rows($sertifikat_result) == 0) {
        ...
        <h2>Anda tidak memiliki sertifikat di Gunung Kidul</h2>
        </div>";
    }
    ?>
        </div>
